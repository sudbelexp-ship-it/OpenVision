...
struct OpenVisionApp: App {
    ...
    init() {
        ...
        // Initialize Meta Wearables SDK. Safe to call even if GlassesManager already forced this
        // (see GlassesManager.sdkConfigured) — a second call just errors harmlessly and we log it.
        do {
